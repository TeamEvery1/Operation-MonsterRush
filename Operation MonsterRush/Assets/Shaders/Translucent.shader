Shader "Custom/Translucent" 
{
	Properties
	{
		...
		//_Thinkness = Thickness texture (invert normals, bake AO).
		...
		//_Scale = Multiplier for traslucent glow = should be per-light, really.
		//_SubColor = Subsurface colour.
		_Thickness ("Thinkness (R)", 2D) = "bump" {}
	...
	SubShader
	{
		...
		sampler2D _MainTex, _BumpMap, _Thinkness;
		...
		void surf (Input IN, inout SurfaceOutput o)
		{
			...
			o.Alpha = tex2D (_Thinkness, IN.uv_MainTex).r;
			o.Gloss = tex.a;
